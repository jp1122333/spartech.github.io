...
const FeedbackCard = ({content, name, title, img}) => 
   (
    ...
    <p className="font-poppins font-normal text-[18px] leading-[32px] text-black my-10">{content}</p>
    <div className="flex flex-row">
       {/* <img src={img} alt={name} className="w-[48px] h-[48px] rounded-full" />  */}
          <div className="flex flex-col ml-4">
              <h4 className="font-poppins font-semibold text-[20px] leading-[32px] text-slate-gray">{name}</h4>
